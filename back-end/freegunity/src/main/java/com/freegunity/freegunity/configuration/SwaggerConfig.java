package com.freegunity.freegunity.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.freegunity.freegunity.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("FreegUnity - Rede Social")
				.description("Projeto Integrador API Spring - Rede Social").version("1.0.0")
				.license("Apache License Version 2.0").licenseUrl("https://github.com/jonpdro/ProjetoIntegrador")
