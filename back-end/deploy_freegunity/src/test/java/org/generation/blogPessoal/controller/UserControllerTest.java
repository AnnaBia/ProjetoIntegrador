...
public class UserControllerTest {
	...
	public void start() throws ParseException {
		// LocalDate data = LocalDate.parse("2003-01-27",
		// DateTimeFormatter.ofPattern("yyyy-MM-dd"));
		// usuarioAdmin = new User(0L, "Administrador", "admin", "123456", data);

		if (!repository.findByUsernameIgnoreCase(usuarioAdmin.getUsuario()).isPresent()) {
...
//		// usuarioUpdate = new User(2L, "João Pedro Cruz Gomes", "jotinha1", "1234567",
//		// dataPut);
